...
#         print (self.parent.listcolumn)
    ...
    def m_listCtrl_tabel_databaseOnLeftDClick(self, event):
        ...
        self.get_item_id_name = self.parent.m_listCtrl_tabel_database.GetItemText(self.item,col=1)
        self.get_item_no_tes = self.parent.m_listCtrl_tabel_database.GetItemText(self.item,col=5)
        ...
        for data in self.query_tabel[0]:
            print (data)
