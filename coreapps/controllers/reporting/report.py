...
pdf.cell(3,th,":",0,0)
pdf.cell(50,th,data_hasil_perhitungan[0]["No Tes"],0,1)

pdf.cell(50,th,"Tanggal Tes",0,0)
pdf.cell(3,th,":",0,0)
pdf.cell(50,th,data_hasil_perhitungan[0]["Tanggal Tes"],0,1)

pdf.cell(50,th,"Nama Peserta",0,0)
pdf.cell(3,th,":",0,0)
pdf.cell(50,th,data_hasil_perhitungan[0]["Nama Peserta"],0,1)

pdf.cell(50,th,"Jenis Kelamin",0,0)
pdf.cell(3,th,":",0,0)
pdf.cell(50,th,data_hasil_perhitungan[0]["Jenis Kelamin"],0,1)

pdf.cell(50,th,"Tanggal Lahir",0,0)
pdf.cell(3,th,":",0,0)
pdf.cell(50,th,data_hasil_perhitungan[0]["Tanggal Lahir"],0,1)

pdf.cell(50,th,"Pendidikan Terakhir",0,0)
pdf.cell(3,th,":",0,0)
pdf.cell(50,th,data_hasil_perhitungan[0]["Pendidikan Terakhir"],0,1)

pdf.cell(50,th,"Jurusan Pendidikan",0,0)
pdf.cell(3,th,":",0,0)
pdf.cell(50,th,data_hasil_perhitungan[0]["Jurusan Pendidikan"],0,1)

pdf.cell(50,th,"Kota",0,0)
pdf.cell(3,th,":",0,0)
pdf.cell(50,th,data_hasil_perhitungan[0]["Kota"],0,1)

pdf.cell(50,th,"Perusahaan / Instansi",0,0)
pdf.cell(3,th,":",0,0)
pdf.cell(50,th,data_hasil_perhitungan[0]["Perusahaan / Instansi"],0,1)

pdf.cell(50,th,"Posisi / Jabatan",0,0)
pdf.cell(3,th,":",0,0)
pdf.cell(50,th,data_hasil_perhitungan[0]["Posisi / Jabatan"],0,1)
...
for datum in data_dimensi:
    ...
    # Move to computed offset
    pdf.x = offset 
    pdf.multi_cell(15,tinggi_kolom,str(datum[1]),"T,L,R",0)
    # pdf.ln(th)
    # Calculate x position of next cell
    pdf.y = top
    offset = pdf.x  + 65
    ...
    # Move to computed offset
    pdf.x = offset 
    pdf.multi_cell(60,3,"hhuuhihinnjnjjknjnjnj jjjnjn ;k;k;lkl;kl;kl;kl;k;lkuhiuhuhiuhiuh","T,L,R",0)
    ...
    # Move to computed offset
    pdf.x = offset 
    pdf.multi_cell(50,tinggi_kolom,str(datum[3]),"T,L,R",0)
