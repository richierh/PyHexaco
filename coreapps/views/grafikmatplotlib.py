...
#             print ("tes")
            ...
            self.y_pos = self.np.arange(len(self.data_y_6_dimensi))
            self.value = [3.14, 5, 4.56, 1.45, 3.67, 2.67,3.66]
...
#         self.axes_honesty_humility.set_xlabel("Sub Dimensi")
...
#         self.axes_Interestial_Scale = self.figure.add_subplot(7, 2, 14)
        ...
        self.axes_grafik_o.bar(self.y_pos, self.performance, xerr=error, width = 0.4,align='center',
