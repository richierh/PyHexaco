...
class DialogSavePDF ( wx.Dialog ):
	...
	def __init__( self, parent ):
		...
		self.m_direktori_pdf = wx.DirPickerCtrl( self.m_panel1, wx.ID_ANY, u"/home/cireng/Documents", u"Select a folder", wx.DefaultPosition, wx.DefaultSize, wx.DIRP_DEFAULT_STYLE )
